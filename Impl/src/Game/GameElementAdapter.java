...
public abstract class GameElementAdapter implements IGameElement
{
	...
	public GameElementAdapter(String ref , int x , int y)
	{
		...
		minX=0;
		maxX=GameConstants.GameWidth-getWidth();
		minY=0;
		maxY=GameConstants.GameHeight-getHeight();
	...
	{
		if (height>0&&height<=GameConstants.GameHeight)
			Height=height;
	}
	...
	{
		if (width>0&&width<=GameConstants.GameWidth)
			Width=width;
	}
